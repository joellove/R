...
```{r}
setwd("~/GitHub/R/coursera/reproducible_research/assignment2")
...
head(stormData, n = 2)
```
There are 874160 rows and 37 columns in total.
...
dim(storm)
```
Now, there are 653363 rows and 38 columns in total.
